...
const projectsData = [
  {
    ...
    description: "Designed and deployed an end-to-end insurance customer prediction system on AWS EC2 using Docker containerization and CI/CD pipelines. Developed a robust Random Forest model achieving 95% overall accuracy, 80% precision, and 90% recall.",
    technologies: ["Python", "Random Forest", "AWS EC2", "Docker", "CI/CD"],
    githubLink: "https://github.com/YashMasane/InsurePredict-Customer-Conversion-Insights",
    bgImage: "https://media.istockphoto.com/id/886772948/photo/customer-diagram.jpg?s=612x612&w=0&k=20&c=Drhn0AgH-pPEFtc5BMmGs5EfWD9ZsL2FLUIcN9BaiB4="
  },
  {
    id: 2,
    title: "MoneyMinds – Intelligent AI Agents for Investments",
    description: "Engineered a multi-agent AI system integrating specialized tools for comprehensive stock analysis. Processed key financial metrics to reduce analysis time by 40% and deliver actionable investment strategies.",
    technologies: ["Python", "Multi-Agent Systems", "CrewAI", "Gemma-2 LLM"],
    githubLink: "https://github.com/YashMasane/MoneyMinds-AI--Intelligent-AI-agents-managing-investments",
    bgImage: "https://img.freepik.com/premium-photo/automated-stock-trading-using-artificial-intelligence-neural-networks_117038-36410.jpg"
  },
  {
    id: 3,
    title: "AI-Generated vs Real Image Classifier",
    description: "Developed an image classification model using EfficientNetB6 with transfer learning to distinguish between AI-generated and real images, achieving precision of 94.50%, recall of 93.67% and accuracy of 94%. Reduced model size by 20% through hyperparameter tuning, delivering a lighter yet equally efficient alternative to EfficientNetB3. Accelerated training time by 35% with GPU optimization and efficient data pipelines.",
...
const skillsLogos = [
  ...
  { name: "Power BI", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/New_Power_BI_Logo.svg/1200px-New_Power_BI_Logo.svg.png" },
  { name: "LangChain", logo: "https://blogs.perficient.com/files/lanchain.png" },
  { name: "Hugging Face", logo: "https://dlab.berkeley.edu/sites/default/files/styles/openberkeley_image_full/public/hugging_face_0.png?itok=EcNqVjG9&timestamp=1639512837" }
];
...
const educationData = [
  {
    ...
    description: "Specialized in Mathematics and Scientific Computing (CPI: 7.48)"
  },
  {
...
const experienceData = [
  {
    ...
    description: "Worked on developing high-precision machine learning models for real-time data analysis. Assisted in feature engineering and optimization of data pipelines, resulting in a 20% improvement in model performance."
  }
];
...
const DataSciencePortfolio = () => {
  ...
  const roles = ["Data Scientist", "Machine Learning Engineer", "AI Researcher"];
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8 items-left">
              ...
              <div className="text-left">
                <p className="text-lg text-gray-700 mb-6">
                  Hello, I'm Yash Raju Masane – a passionate Data Scientist with a strong foundation in Mathematics and Scientific Computing. I specialize in leveraging advanced machine learning, deep learning, and AI techniques to transform data into actionable insights.
                </p>
                <p className="text-lg text-gray-700 mb-6">
                  My journey in data science has been enriched by hands-on experience, including a Machine Learning Internship at Anubrain Technologies where I developed high-precision models and optimized feature selection processes.
                </p>
                <p className="text-lg text-gray-700 mb-6">
                  Holding an M.Sc. from MNIT Allahabad and a B.Sc. from Nagpur University, I continuously push the envelope in innovation—clearing GATE 2024 and JAM 2022 are testaments to my commitment to excellence.
                </p>
                <div className="mt-8">
                  <a 
                    href={yash_resume} 
      ...
      <footer className="bg-gray-800 text-white py-6">
        <div className="container mx-auto px-4 text-center">
          <div className="flex justify-center space-x-6 mb-4">
            <a href="https://github.com/YashMasane" className="hover:text-blue-400">
              <Github size={24} />
            </a>
            <a href="https://www.linkedin.com/in/yashm08/" className="hover:text-blue-400">
              <Linkedin size={24} />
            </a>
            <a href="mailto:masaneyash6@gmail.com" className="hover:text-blue-400">
              <Mail size={24} />
            </a>
          </div>
